...
class Window(tk.Tk):
    def __init__(self):
        ...
        self.error_screen_fr = ErrorScreen(self)
    ...
    def update_screen(self):
        ...
        self.error_screen_fr.pack_forget()
...
class CancelScreen(tk.Frame):
    def __init__(self, master):
        super().__init__(master)
        self.cancel_in_progress_lb = tk.Label(
            self, text="Canceling update, please wait..."
        )
        self.cancel_in_progress_lb.pack()
