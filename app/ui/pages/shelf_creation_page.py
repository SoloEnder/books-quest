...
class ShelfCreationPage(QtWidgets.QWidget):
    def __init__(
        ...
        for shelf in self.books_handler.books_shelfs.values():
            shelf_item = QtGui.QStandardItem(shelf.name)
        ...
        self.main_widget_lyt.addWidget(
            self.books_tree, 2, 0, QtCore.Qt.AlignmentFlag.AlignLeft
        )


class ShelfInfosInputWidget(QtWidgets.QWidget):
    def __init__(
        self,
        parent: QtWidgets.QWidget | None,
        books_handler: book_stuff.BooksHandler,
