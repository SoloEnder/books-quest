...
class NotificationService:
    ...
    def __init__(
        ...
        self.default_warning_infos = {
            "title":self.langs_handler.get_value("notification_service.error.title"), 
            "msg":self.langs_handler.get_value("notification_service.error.msg")}
        self.default_information_infos = {"title":self.langs_handler.get_value("notification_service.info.title")}
